...
describe("AppNavbar tests", () => {
    ...
    test("renders the All Searches menu correctly", async () => {
        const currentUser = currentUserFixtures.userOnly;
        const systemInfo = systemInfoFixtures.showingBoth;
        ...
        expect(await screen.findByTestId("appnavbar-search-dropdown")).toBeInTheDocument();
        const dropdown = screen.getByTestId("appnavbar-search-dropdown");
        const aElement = dropdown.querySelector("a");
        expect(aElement).toBeInTheDocument();
        aElement?.click();
